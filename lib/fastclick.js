;(function () {
	...
	*/
	...
	FastClick.prototype.sendClick = function(targetElement, event) {
		...
		// Ghostclick
		if(this.enableGhostClickCheck || deviceIsAndroid) {
			this.clickedNow();
		}
	};
	...
	FastClick.prototype.onTouchStart = function(event) {
		var targetElement, typeAttribute, touch, selection, nodeName;
		...
		typeAttribute = targetElement.getAttribute('type');
	...
	FastClick.prototype.onMouse = function(event) {
		...
		if ((this.enableGhostClickCheck || deviceIsAndroid) && this.isGhostClick()) {
